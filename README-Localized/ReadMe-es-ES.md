# <a name="office-add-in-that-uses-the-oauthio-service-to-get-authorization-to-external-services"></a>Complemento de Office que usa el servicio OAuth.io para obtener autorización a los servicios externos
